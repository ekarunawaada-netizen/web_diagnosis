          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto">
              ...
              <div className="md:col-span-2 bg-surface-container-highest rounded-[2.5rem] p-8 shadow-sm hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:-translate-y-2 transition-all duration-500 overflow-hidden relative group flex flex-col justify-center">
                ...
                <div className="absolute right-0 bottom-0 top-0 w-1/2 opacity-20 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none translate-x-12 translate-y-12 group-hover:translate-x-4 group-hover:translate-y-4">
                  <span className="material-symbols-outlined text-[300px] text-primary" style={{ fontVariationSettings: "'FILL' 1" }}>psychology</span>
                </div>
              </div>

              {/* Box 2 (Standard) - Security */}
              <div className="bg-gradient-to-br from-tertiary to-tertiary-container rounded-[2.5rem] p-10 text-on-tertiary-container shadow-md hover:shadow-[0_20px_40px_rgba(92,107,192,0.2)] hover:scale-[1.03] transition-all duration-500 flex flex-col justify-center items-start group">
                <span className="material-symbols-outlined text-5xl mb-6 group-hover:animate-bounce" style={{ fontVariationSettings: "'FILL' 1" }}>gpp_good</span>
                <h3 className="text-2xl font-black font-headline mb-3 text-tertiary">Otoritas Privasi</h3>
                <p className="opacity-80 font-medium leading-relaxed">Semua metadata dilumuri lapisan enkripsi AES Tingkat Paripurna. Rekam medis Anda adalah hak kekayaan intelektual absolut Anda seorang.</p>
              </div>

              {/* Box 3 (Standard) - Tracking */}
              <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-[2.5rem] p-10 hover:border-primary/50 hover:bg-surface-container-low hover:-translate-y-2 transition-all duration-500 group flex flex-col">
                ...
                <p className="text-on-surface-variant font-medium leading-relaxed flex-1">Terhubung langsung dengan Satelit Google Maps API. Cari ratusan pintu rumah sakit tepat di radius tempat Anda berdiri saat ini.</p>
